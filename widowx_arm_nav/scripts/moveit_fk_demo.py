...
class MoveItDemo:
    def __init__(self):
        ...
        right_arm = moveit_commander.MoveGroupCommander('widowx_arm')
        
        # Connect to the right_gripper move group
        #right_gripper = moveit_commander.MoveGroupCommander('widowx_gripper')
        ...
        right_arm.set_named_target('default_pose')
        ...
        right_arm.set_named_target('pulled_back_pose')
        ...
        right_arm.set_named_target('alternate_pose')
        right_arm.go()
        rospy.sleep(1)
